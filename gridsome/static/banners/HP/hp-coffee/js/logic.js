...
function animation(){
    ...
    .to(frame1, .8,{x: -10, opacity: 0, ease:Sine.easeOut}, 2.5)
    .from(frame2, .8,{x:10, opacity: 0, ease:Sine.easeOut}, 2.6)
    .from(title2, .8,{x:-5, opacity: 0, ease:Sine.easeOut}, 2.8)
    
	//2ND FRAME
    .to(frame1, .5,{opacity: 0, scale: 0.6, ease:Sine.easeOut}, 4.9)
    .to(title2, .8,{x:5, opacity: 0, ease:Sine.easeOut}, 4.9)
    .to(frame2, .5,{x:5, opacity: 0, ease:Sine.easeOut}, 5)
