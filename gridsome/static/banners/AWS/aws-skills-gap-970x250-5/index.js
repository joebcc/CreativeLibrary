...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[0,903,524,118],[471,510,524,118],[471,630,524,118],[471,750,220,39],[693,750,220,39],[769,791,220,39],[0,0,608,508],[0,805,767,96],[912,76,67,40],[912,0,81,74],[0,510,469,293],[610,0,300,250],[769,832,127,38],[526,903,300,84]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,-61.1,262,59);
...
}).prototype = getMCSymbolPrototype(lib.VectorSmartObject_1, new cjs.Rectangle(0,0,172,48.2), null);
...
(lib.Layer11_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.Layer11_1, new cjs.Rectangle(0,0,469,293), null);


(lib.jumper_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.jumper();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.jumper_1, new cjs.Rectangle(0,0,81,74), null);


(lib.Cliffs_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.Cliffs();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Cliffs_1, new cjs.Rectangle(0,0,767,96), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	var mask_graphics_79 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJoEPIg2BpIA4B/IgMCzIBSjIIAoh3Ig+hSIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_80 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJrEQIgxBsIA1B5IgRC1IBSjIIAkh0Ig6hVIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_81 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJuESIgsBuIAxB0IgVC2IBSjIIAhhxIg3hYIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_82 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJwEUIgnBwIAuBuIgZC4IBSjIIAdhvIgzhaIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_83 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJzEWIgjBxIArBqIgdC5IBSjIIAahsIgwhdIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_84 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJ3EXIgfB1IAnBkIghC6IBSjIIAXhpIgthgIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_85 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJ5EZIgaB2IAjBgIgkC7IBSjIIAThnIgphiIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_86 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJ8EaIgVB5IAgBbIgpC8IBSjIIAQhkIgmhlIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_87 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIJ/EcIgQB7IAcBVIgtC+IBSjIIANhiIgjhnIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_88 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIKBEeIgKB9IAZBQIgyC/IBSjIIAJhfIgfhqIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_89 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIKEEgIgGB/IAVBLIg1DAIBSjIIAHhcIgdhtIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_90 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIKHEiIgDCAIATBGIg5DCIBSjIIADhaIgZhvIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_91 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIKKEjIACCEIAQBBIg+DCIBSjIIgBhXIgVhyIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_92 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIKNEkIAHCGIAMA8IhCDEIBSjIIgEhUIgSh1IJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_93 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIKQEmIAMCIIAJA3IhHDFIBSjIIgWjJIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_94 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIKTEoIAQCKIAFAxIhKDHIBSjIIgLhPIgLh6IJ1kjIGDDjIg4CRIAPCLIkWJLg");
	var mask_graphics_95 = new cjs.Graphics().p("ArVImIgGh1Ik4nUIBDiNIATiPIE/jbIKTEoIABALIAIACIgCgcIJ1kjIGDDjIg4CRIAPCLIkWJLg");
	...
	this.instance.setTransform(-66.55,-150.7,1.1664,1.1664,0,0,0,33.1,0.7);
...
p.nominalBounds = new cjs.Rectangle(-105.1,-151.5,200.6,56.2);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// jumper
	this.instance = new lib.jumper_1();
	this.instance.setTransform(378.5,124,1,1,0,0,0,40.5,37);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Cliffs
	this.instance_1 = new lib.Cliffs_1();
	this.instance_1.setTransform(383.5,238,1,1,0,0,0,383.5,48);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Layer_11
	this.instance_2 = new lib.Layer11_1();
	this.instance_2.setTransform(332.5,146.5,1,1,0,0,0,234.5,146.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(0,0,767,293), null);


// stage content:
(lib.T1BridgeTheGap300x250 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// cta
	this.instance = new lib.cta();
	this.instance.setTransform(150,105,1,1,0,0,0,-3,-75);
	this.instance.alpha = 0;
	this.instance._off = true;
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.cta(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(197).to({_off:false},0).wait(1).to({regX:63.5,regY:19,x:216.5,y:201.35,alpha:0.1111},0).wait(1).to({y:204,alpha:0.2222},0).wait(1).to({y:206.8,alpha:0.3333},0).wait(1).to({y:209.55,alpha:0.4444},0).wait(1).to({y:212.25,alpha:0.5556},0).wait(1).to({y:214.7,alpha:0.6667},0).wait(1).to({y:216.8,alpha:0.7778},0).wait(1).to({y:218.35,alpha:0.8889},0).wait(1).to({y:219,alpha:1},0).wait(1).to({regX:-3,regY:-75,x:150,y:125},0).wait(1).to({regX:63.5,regY:19,x:216.5,y:219},0).wait(91));

	// Logo
	this.instance_1 = new lib.Logo();
	this.instance_1.setTransform(44,219,1,1,0,0,0,24,14);
	...
	this.instance_3.setTransform(209,219.35,1,1,0,0,0,0,-72);
	this.instance_3._off = true;
	...
	this.instance_4.setTransform(0,41.9,1,1,0,0,0,0,-30.6);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(173).to({_off:false},0).wait(1).to({regX:131,regY:-31.6,x:132.6,y:40.9,alpha:0.0588},0).wait(1).to({x:134.25,alpha:0.1176},0).wait(1).to({x:135.9,alpha:0.1765},0).wait(1).to({x:137.55,alpha:0.2353},0).wait(1).to({x:139.2,alpha:0.2941},0).wait(1).to({x:140.85,alpha:0.3529},0).wait(1).to({x:142.5,alpha:0.4118},0).wait(1).to({x:144.15,alpha:0.4706},0).wait(1).to({x:145.8,alpha:0.5294},0).wait(1).to({x:147.45,alpha:0.5882},0).wait(1).to({x:149.1,alpha:0.6471},0).wait(1).to({x:150.75,alpha:0.7059},0).wait(1).to({x:152.4,alpha:0.7647},0).wait(1).to({x:154.05,alpha:0.8235},0).wait(1).to({x:155.7,alpha:0.8824},0).wait(1).to({x:157.35,alpha:0.9412},0).wait(1).to({x:159,alpha:1},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));

	// will_be_disrupted_by_IT_skills_gaps
	this.instance_5 = new lib.Symbol1("synched",0);
	this.instance_5.setTransform(0,41.9,1,1,0,0,0,0,-30.6);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(76).to({_off:false},0).wait(1).to({regX:131,regY:-31.6,x:133.8,y:40.9,alpha:0.1},0).wait(1).to({x:136.6,alpha:0.2},0).wait(1).to({x:139.4,alpha:0.3},0).wait(1).to({x:142.2,alpha:0.4},0).wait(1).to({x:145,alpha:0.5},0).wait(1).to({x:147.8,alpha:0.6},0).wait(1).to({x:150.6,alpha:0.7},0).wait(1).to({x:153.4,alpha:0.8},0).wait(1).to({x:156.2,alpha:0.9},0).wait(1).to({x:159,alpha:1},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:161.3,alpha:0.9231},0).wait(1).to({x:163.6,alpha:0.8462},0).wait(1).to({x:165.9,alpha:0.7692},0).wait(1).to({x:168.2,alpha:0.6923},0).wait(1).to({x:170.55,alpha:0.6154},0).wait(1).to({x:172.85,alpha:0.5385},0).wait(1).to({x:175.15,alpha:0.4615},0).wait(1).to({x:177.45,alpha:0.3846},0).wait(1).to({x:179.75,alpha:0.3077},0).wait(1).to({x:182.05,alpha:0.2308},0).wait(1).to({x:184.35,alpha:0.1538},0).wait(1).to({x:186.65,alpha:0.0769},0).wait(1).to({x:189,alpha:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));

	// By_2020__75__of_organizations
	this.instance_6 = new lib.t1("synched",0);
	this.instance_6.setTransform(0.05,41.9,1,1,0,0,0,0,-30.6);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({_off:false},0).wait(1).to({regX:131,regY:-31.6,x:133.35,y:40.9,alpha:0.0833},0).wait(1).to({x:135.7,alpha:0.1667},0).wait(1).to({x:138,alpha:0.25},0).wait(1).to({x:140.35,alpha:0.3333},0).wait(1).to({x:142.65,alpha:0.4167},0).wait(1).to({x:145,alpha:0.5},0).wait(1).to({x:147.35,alpha:0.5833},0).wait(1).to({x:149.65,alpha:0.6667},0).wait(1).to({x:152,alpha:0.75},0).wait(1).to({x:154.3,alpha:0.8333},0).wait(1).to({x:156.65,alpha:0.9167},0).wait(1).to({x:159,alpha:1},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:162.3,alpha:0.8889},0).wait(1).to({x:165.65,alpha:0.7778},0).wait(1).to({x:169,alpha:0.6667},0).wait(1).to({x:172.3,alpha:0.5556},0).wait(1).to({x:175.65,alpha:0.4444},0).wait(1).to({x:179,alpha:0.3333},0).wait(1).to({x:182.3,alpha:0.2222},0).wait(1).to({x:185.65,alpha:0.1111},0).wait(1).to({x:189,alpha:0},0).to({_off:true},1).wait(223));

	// bg
	this.instance_7 = new lib.bg();
	this.instance_7.setTransform(211.5,134.5,1,1,0,0,0,383.5,146.5);
...
p.nominalBounds = new cjs.Rectangle(-22,105,617,176);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1576618910894", id:"index_atlas_"}
	],
	preloads: []
};
